...
module.exports = {
  name: "stop",
  description: "[MÚSICA] Para a música atual ",
  ...
  run: async (client, interaction) => {
    ...
    return void interaction.editReply({embeds: success ? [{description:`❌ | Parando **${currentTrack.name}**!`,color:`${client.colour}`}] : [{description:`❌ | Alguma coisa deu errado!`,color:`${client.colour}`}]})
  },
};
